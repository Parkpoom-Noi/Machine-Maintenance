...
Public Class frmMT_MGR
    ...
    Private Sub frmMT_MGR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If dt_username.Rows.Count > 0 Then
            ...
            Me.lb_nameData.Text = dt_username.Rows(0)("user_name").ToString
...
#Region "For Maintenance"
    ...
    Private Sub frmMT_FormClosed(sender As Object, e As FormClosedEventArgs)
        Application.Exit()
    End Sub
...
#Region " All DATA TPM"
    Private Sub DGV_TOTAL()
        DGV.DataSource = BLL.GetTotal()
    End Sub
...
#Region "Global All"
    ...
    Private Sub frmMT_MGR_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
